...
{
    /// <summary>
    /// Puts extra cheese on the pizza.
    /// </summary>
    public class PutExtraCheeseOn : PizzaDecoratorBase
    {
        /// <summary>
        ...
        /// </exception>
        public PutExtraCheeseOn(IPizza pizza) : base(pizza) { }
        ...
        public override string GetPizzaType()
            => base.GetPizzaType() + Resources.PizzaTopping_ExtraCheese;
    }
}